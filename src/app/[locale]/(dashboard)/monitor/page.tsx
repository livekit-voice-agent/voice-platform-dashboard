        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            <h1 className="text-2xl font-bold tracking-tight flex items-center gap-2.5">
              Monitor de Agentes
              <span className="inline-flex items-center gap-1 text-[11px] font-semibold uppercase tracking-wider px-2 py-0.5 rounded-full bg-amber-100 text-amber-700 border border-amber-300 dark:bg-amber-900/30 dark:text-amber-400 dark:border-amber-700">
                β Beta
              </span>
            </h1>
            <p className="text-sm text-muted-foreground">
              ...
              <span className="text-amber-600 dark:text-amber-400 font-medium">Esta tela está em fase de testes (beta) — dados podem ser imprecisos.</span>
            </p>
          </div>
          <Link
            href="/monitor/costs"
